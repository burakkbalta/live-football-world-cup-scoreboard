...
public class TotalScoreAndStartTimeComparatorTest {
    private static Stream<Arguments> totalScoreAndStartTimeComparatorsDataProvider() {
        return Stream.of(
            Arguments.of(
    ...
    @MethodSource("totalScoreAndStartTimeComparatorsDataProvider")
    public void testCompareInternally(Match match1, MatchScore matchScore1, 
        ...
        IMatchComparator totalScoreComparator = MatchComparatorFactory.getMatchComparator(ComparatorTypes.InOrderByTotalScoreAndLastAddedTime,
             isAscending);        
